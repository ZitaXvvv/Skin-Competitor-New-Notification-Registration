...
## 这是什么？ What is this?
一个网页看板，包含两个页面：
1. **新品月历（主页）**：按季度月历展示各竞品品牌的新备案/注册产品（成分、功效宣称、PDF、产品图）
2. **🏆 Hero SKU Matrix**：品牌 × 系列 × 护肤步骤的明星单品全景矩阵
...
品牌旗下各系列在不同护肤步骤上的明星单品全景视图。

### 矩阵结构
- **行**：品牌 × 系列（如 珀莱雅 - 红宝石系列）
- **列**：15个护肤步骤（洁面 → 水 → 精华 → 霜 → 眼霜 → 面膜 → 防晒 → 其他）
- **格内**：该系列在该步骤的明星单品名称和价格

### 筛选方式
左侧边栏可选择要对比的品牌（可多选，默认显示前3个）。

### 覆盖品牌
珀莱雅、欧莱雅、雅诗兰黛、科颜氏、修丽可、谷雨、欧诗漫、兰蔻。
